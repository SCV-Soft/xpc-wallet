...
import com.xpchain.wallet.exchangerate.ExchangeRatesRepository;
import com.xpchain.wallet.ui.RequestCoinsActivity;
import com.xpchain.wallet.ui.SendCoinsQrActivity;
...
public class WalletBalanceWidgetProvider extends AppWidgetProvider {
    ...
    private static void updateWidget(final Context context, final AppWidgetManager appWidgetManager,
        ...
        views.setOnClickPendingIntent(R.id.widget_button_balance,
                PendingIntent.getActivity(context, 0, new Intent(context, WalletActivity.class), PendingIntent.FLAG_MUTABLE));
        views.setOnClickPendingIntent(R.id.widget_button_request,
                PendingIntent.getActivity(context, 0, new Intent(context, RequestCoinsActivity.class), PendingIntent.FLAG_MUTABLE));
        views.setOnClickPendingIntent(R.id.widget_button_send,
                PendingIntent.getActivity(context, 0, new Intent(context, SendCoinsActivity.class), PendingIntent.FLAG_MUTABLE));
        views.setOnClickPendingIntent(R.id.widget_button_send_qr,
                PendingIntent.getActivity(context, 0, new Intent(context, SendCoinsQrActivity.class), PendingIntent.FLAG_MUTABLE));

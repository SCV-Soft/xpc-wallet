...
package com.xpchain.wallet.util;
...
public class Bluetooth {
    ...
    public static final String BIP70_PAYMENT_PROTOCOL_NAME = "XPChain BIP70 payment protocol";
    ...
    public static final String CLASSIC_PAYMENT_PROTOCOL_NAME = "XPChain classic payment protocol (deprecated)";
